    ...
    return {
      navItems: [
        { 
          ...
          icon: '🔍',
          faviconUrl: 'https://www.google.com/s2/favicons?domain=bing.com&sz=16'
        },
        { 
          name: '谷歌学术', 
        ...
        { 
          ...
          icon: '📖',
          faviconUrl: 'https://www.google.com/s2/favicons?domain=cnki.net&sz=16'
        },
        { 
          name: 'Github', 
        ...
        { 
          ...
          icon: '⚖️',
          faviconUrl: 'https://www.google.com/s2/favicons?domain=soopat.com&sz=16'
        },
        { 
          name: '纬度学术', 
          url: 'https://sso.hnlat.com/', 
          icon: '🧪',
          faviconUrl: 'https://www.google.com/s2/favicons?domain=hnlat.com&sz=16'
        }
      ]
    }
  }
